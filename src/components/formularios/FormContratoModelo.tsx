    ...
    <>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 h-full flex flex-col">
          ...
          <Card>
              <CardHeader><CardTitle className="text-xl">Configuração do Modelo</CardTitle></CardHeader>
              <CardContent>
                  <FormField
                      ...
                      render={({ field }) => (
                          <FormItem>
                              ...
                              <FormControl><Input placeholder="Ex: Contrato de Prestação de Serviços" {...field} /></FormControl>
                              <FormMessage />
                          </FormItem>
                      )}
                  />
