...
import { PeriodoAquisitivo } from '@/types/ferias';
...
const FormFerias: React.FC<FormFeriasProps> = ({ usuarioInicial, isReadOnly }) => {
  ...
  const {
      ...
      isUserOfAdmin // Passando a flag de admin para o hook buscar os registros na tabela correta
  );
                ...
                {carregandoCLT ? (
                    ...
                    <div className="p-4 bg-red-100 dark:bg-red-900/20 border border-red-500 rounded-md">
                        <p className="text-sm font-semibold text-red-700 dark:text-red-300">
                            Aviso: A data de início do contrato não está definida. Preencha na aba 'Contrato (RH)' para calcular os períodos aquisitivos.
                        </p>
                    </div>
                ) : (
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div className="p-3 bg-secondary rounded-md">
                                ...
                                <p className="text-lg font-bold mt-1">{ultimaFeriasFim ? format(ultimaFeriasFim, 'dd/MM/yyyy', { locale: ptBR }) : 'Nenhuma'}</p>
                            </div>
            ...
            <CardContent>
                {isUserOfAdmin ? (
                    <GerenciarFeriasAdmin
                        ...
                        readOnly={isReadOnly} // Passando isReadOnly
                    />
                ) : (
                    <GerenciarFerias 
                        funcionarioId={usuarioInicial.id} 
