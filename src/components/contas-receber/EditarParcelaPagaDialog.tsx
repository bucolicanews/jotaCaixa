...
<dyad-write path="src/components/contas-receber/RegistrarPagamentoDialog.tsx" description="Refatorando a lógica de salvamento de recebimentos para garantir a criação correta de lançamentos contábeis em partidas dobradas, incluindo taxas e descontos.">
