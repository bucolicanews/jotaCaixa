...
const ContasReceber = () => {
  ...
  const handleDelete = async (contaId: string) => {
    if (!window.confirm('Tem certeza que deseja excluir esta conta? A ação não pode ser desfeita.')) return;
    ...
    <LayoutPrincipal>
      <div className="flex justify-between items-center mb-6">
        ...
        <Dialog open={dialogAberto} onOpenChange={setDialogAberto}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>{contaSelecionada ? 'Editar Conta' : 'Nova Conta a Receber'}</DialogTitle>
            </DialogHeader>
            <FormContasReceber 
