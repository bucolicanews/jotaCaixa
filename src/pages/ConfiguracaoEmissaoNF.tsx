...
const DEFAULT_CONFIG: NFConfig = {
    webhook_n8n_url: '',
    template_whatsapp:
        'Olá {cliente_nome}! Sua Nota Fiscal Nº {numero_nota} no valor de {valor} foi emitida. Segue o anexo.',
    template_email:
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card className="lg:col-span-2">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Configure a URL do seu webhook N8N para automatizar
                            a emissão e o envio da NF.
                        </CardDescription>
                    </CardHeader>
                    ...
                    <CardContent className="space-y-4">
                        <Alert className="border-amber-500 bg-amber-50 dark:bg-amber-900/20">
                            ...
                            <AlertDescription className="text-xs text-amber-700 dark:text-amber-300">
                                O sistema enviará o ID da parcela, o ID do
                                proprietário e a URL do anexo (após upload) para
                                este webhook. O webhook deve retornar status 200
                                OK.
                            </AlertDescription>
                        </Alert>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setConfig({
                                        ...config,
                                        webhook_n8n_url: e.target.value,
                                    })
                                }
                                disabled={isReadOnly}
                            />
                ...
                <Card>
                    ...
                    <CardContent className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                            ...
                            <code>{'{numero_nota}'}</code>,{' '}
                            <code>{'{valor}'}</code>,{' '}
                            <code>{'{empresa_nome}'}</code>,{' '}
                            <code>{'{link_anexo}'}</code>
                        </p>
                    </CardContent>
                </Card>
...
export default ConfiguracaoEmissaoNF;