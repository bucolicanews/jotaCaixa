-- Fix parcelas_contas_receber RLS policies - drop and recreate

-- Drop existing policies if they exist
DROP POLICY IF EXISTS "parcelas_contas_receber_select_policy" ON public.parcelas_contas_receber;
DROP POLICY IF EXISTS "parcelas_contas_receber_insert_policy" ON public.parcelas_contas_receber;
DROP POLICY IF EXISTS "parcelas_contas_receber_update_policy" ON public.parcelas_contas_receber;
DROP POLICY IF EXISTS "parcelas_contas_receber_delete_policy" ON public.parcelas_contas_receber;
